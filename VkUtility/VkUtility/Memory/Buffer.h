...
[[nodiscard]] inline VkBufferWrapped allocate_cpu_buffer(const VkBufferCreateInfo& buffer_info,
  ...
  return VkBufferWrapped{VMABufferHandle{buffer_info, info, allocator}};
}

[[nodiscard]] inline VkBufferWrapped allocate_gpu_buffer(const VkBufferCreateInfo& buffer_info,
                                                         VmaAllocator allocator) {
...
[[nodiscard]] inline VkBufferWrapped create_and_write_to_gpu_buffer(const ImmediateSubmit& submit,
  ...
  submit.submit([&](VkCommandBuffer cmd) {
    ...
    vkCmdCopyBuffer(cmd, staging_buffer(), gpu_buffer(), 1, &copy);
  });
